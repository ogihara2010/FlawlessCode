...
namespace Flawless_ex
{
    public partial class DeliveryPreview : Form
    {
        ...
        decimal amount011;
        decimal amount012;
        public DeliveryPreview(MainMenu mainMenu, int id, int type, int control)
        {
            InitializeComponent();
        ...
        private void pd_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            if (types == 0)
            {
                ...
                connA.ConnectionString = @"Server = localhost; Port = 5432; User Id = postgres; Password = postgres; Database = master;"; //変更予定
            ...
            if (types == 1)
            {
                ...
                connI.ConnectionString = @"Server = localhost; Port = 5432; User Id = postgres; Password = postgres; Database = master;"; //変更予定
